  ...
  return (
    <>
      ...
      <div className="mt-18 pt-10 px-4">
        ...
        <p className="text-accent mt-2 mb-10 max-sm:mb-15 text-sm lg:mx-auto md:text-center lg:w-[50%]">Clivo is a platform for writers who demands excellence. Craft, Publish, and share your stories with a community that values quality</p>
        <PhotoGrid />
      </div>
